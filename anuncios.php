        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/anuncio4.png" alt="anuncio">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa de Lujo en el Lago</h3>
                    <p>Casa en el Lago con exelente vista, acabados de lujo a un excelente precio</p>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/anuncio5.png" alt="anuncio">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa Terminado de Lujo</h3>
                    <p>Casa en el Lago con exelente vista, acabados de lujo a un excelente precio</p>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/anuncio6.png" alt="anuncio">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa con alberca</h3>
                    <p>Casa en el Lago con exelente vista, acabados de lujo a un excelente precio</p>
