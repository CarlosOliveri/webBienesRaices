<?php
    ...
    $resultPropiedades= mysqli_query($db,$consultaPropiedades);
    $resultPropiedades = mysqli_fetch_assoc($resultPropiedades);
    
    //arreglo para almacenar errores
    $errores = [];

    $titulo = $resultPropiedades['titulo'];
    $precio = $resultPropiedades['precio'];
    $descripcion = $resultPropiedades['descripcion'];
    $habitaciones = $resultPropiedades['habitaciones'];
    $wc = $resultPropiedades['wc'];
    $estacionamientos = $resultPropiedades['estacionamientos'];
    $vendedor = $resultPropiedades['vendedores_id'];
    $imagenPropiedad = $resultPropiedades['imagen'];
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if(empty($errores)){
            ...
            if($imagen['name']){
                ...
                $nombreImagen = $resultPropiedades['imagen'];
            }
        ...
        <form class="formulario" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="input">
                    ...
                    <img src="/imagenes/<?php echo $imagenPropiedad ?>" class="imagen-small" alt="Imagen de Propiedad">
                </div>
